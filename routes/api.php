...
Route::get('/databooks/{id}', [DatabookController::class, 'index']);
...
Route::get('/penerbits/{id}', [PenerbitController::class, 'index']);
...
Route::get('/categories/{id}', [CategorybookController::class, 'index']);
...
Route::get('/pinjams/{id}', [TransaksiPinjamController::class, 'index']);
